      ...
      <div className={isSel ? "card bg-primary" : "card"} onClick={handleClick}>
        <div className="text-center">
          <Tooltip
            placement="top"
            overlay={
              <div style={{ height: 20, width: "100%" }}>Status: {iconCls}</div>
            }
        ...
        <div className="card-body text-center">
          ...
          <p
            className={
              isSel
                ? "card-title mb-1 font-weight-bold text-truncate text-light"
                : "card-title mb-1 font-weight-bold text-truncate text-muted"
            }
          >
            {activityName}
          </p>
