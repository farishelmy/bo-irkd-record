...
export default function ListView({activityName,activityUri,markOnSel,workflowName,assignedTo,activityDateDue,iconCls,isSel,supervisor,priority,estDuration}) {
    const handleClick=(e)=>{
